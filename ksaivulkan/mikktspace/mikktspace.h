 ...
 * evaluation of tangent space for meshes consisting of triangles and quads. This means faces can be
 * received in any order and the same is true for the order of vertices of each face. The generated
 * result will not be affected by such reordering. Additionally, whether degenerate (vertices or
 * texture coordinates) primitives are present or not will not affect the generated results either.
