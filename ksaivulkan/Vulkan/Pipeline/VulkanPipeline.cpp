...
{
	template<>
	VulkanPipeline<2, PipelineContext::Default>
		::VulkanPipeline(const VulkanDevice& inDevice, VulkanPipelineCache& inCache, const VulkanPipelineContextBase& inContext, const VulkanRenderPassBase& inRenderPass, const VulkanPipelineLayoutBase& inLayout, const std::array<VulkanShaderModule, 2>& inModules)
...
{
	template<>
	VulkanPipeline<1, PipelineContext::Compute>
		::VulkanPipeline(const VulkanDevice& inDevice, VulkanPipelineCache& inCache, const VulkanPipelineContextBase& inContext, const VulkanRenderPassBase& inRenderPass, const VulkanPipelineLayoutBase& inLayout, const std::array<VulkanShaderModule, 1>& inModules)
		: VulkanPipelineBase(inDevice)
	{
