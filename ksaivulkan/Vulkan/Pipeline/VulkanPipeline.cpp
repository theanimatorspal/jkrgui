...
void VulkanPipelineBase::FillVertexInputDescriptions(const spirv_cross::ShaderResources& Resources,
                                                     ...
                                                     std::vector<vk::VertexInputAttributeDescription>& InputAttrDescription) {
               {
                              ...
                              std::sort(InputAttrDescription.begin(), InputAttrDescription.end(), [](const auto& lhs, const auto& rhs) { return lhs.location < rhs.location; });
...
void VulkanPipelineBase::BuildPipeline(VulkanPipelineCache& inCache,
               ...
               if (inPipelineContext == PipelineContext::Compute) {
                              auto ShaderStageCreateInfo =
                                        vk::PipelineShaderStageCreateInfo(vk::PipelineShaderStageCreateFlags(), vk::ShaderStageFlagBits::eCompute, inModules[0].GetShaderModuleHandle(), "GlslMain");
               ...
               if (inPipelineContext == PipelineContext::Default) {
                              ...
                              auto PipelineVertexInputStateCreateInfo = vk::PipelineVertexInputStateCreateInfo(vk::PipelineVertexInputStateCreateFlags(), VertexInputBindingDesp, InputAttrDescription);
                              auto PipelineInputAssemblyStateCreateInfo = vk::PipelineInputAssemblyStateCreateInfo(vk::PipelineInputAssemblyStateCreateFlags(), inContext.GetTopology());
                              ...
                              auto PipelineViewportStateCreateInfo      = vk::PipelineViewportStateCreateInfo(vk::PipelineViewportStateCreateFlags(), 1, nullptr, 1, nullptr);
                              auto PipelineRasterizationStateCreateInfo = vk::PipelineRasterizationStateCreateInfo(vk::PipelineRasterizationStateCreateFlags(),
                                                                                                                   false,
                                                                                                                   false,
                                                                                                                   ...
                                                                                                                   0.0f,
                                                                                                                   1.0f);
                              auto PipelineMultisampleStateCreateInfo   = vk::PipelineMultisampleStateCreateInfo(vk::PipelineMultisampleStateCreateFlags(),
                                                                                                               // TODO Add this to Parameter
                                                                                                               vk::SampleCountFlagBits::e4);
                              auto StencilOpState                       = vk::StencilOpState(vk::StencilOp::eKeep, vk::StencilOp::eKeep, vk::StencilOp::eKeep, vk::CompareOp::eAlways);
                              ...
                              auto ColorComponentFlags = vk::ColorComponentFlagBits::eR | vk::ColorComponentFlagBits::eG | vk::ColorComponentFlagBits::eB | vk::ColorComponentFlagBits::eA;
                              ...
                              auto PipelineColorBlendStateCreateInfo = vk::PipelineColorBlendStateCreateInfo(
                                        vk::PipelineColorBlendStateCreateFlags(), false, vk::LogicOp::eCopy, PipelineColorBlendAttachmentState, {{1.0f, 1.0f, 1.0f, 1.0f}});
                              ...
                              GraphicsPipelineCreateInfo.setRenderPass(inRenderPass.GetRenderPassHandle()).setLayout(inLayout.GetPipelineLayoutHandle());
