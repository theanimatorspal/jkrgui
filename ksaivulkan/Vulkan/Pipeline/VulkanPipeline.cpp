...
VulkanPipeline<2, PipelineContext::Default>::VulkanPipeline(const VulkanDevice& inDevice,
                                                            ...
                                                            const std::array<VulkanShaderModule, 2>& inModules)
    : VulkanPipelineBase(inDevice) {
          ...
          auto PipelineVertexInputStateCreateInfo =
                    vk::PipelineVertexInputStateCreateInfo(vk::PipelineVertexInputStateCreateFlags(), VertexInputBindingDesp, InputAttrDescription);
          ...
          auto PipelineDepthStencilStateCreateInfo = vk::PipelineDepthStencilStateCreateInfo(vk::PipelineDepthStencilStateCreateFlags(),
                                                                                             true,
                                                                                             true,
          ...
          auto PipelineColorBlendAttachmentState = vk::PipelineColorBlendAttachmentState(true,
                                                                                         ...
                                                                                         vk::BlendOp::eAdd,
                                                                                         ColorComponentFlags);
          auto PipelineColorBlendStateCreateInfo = vk::PipelineColorBlendStateCreateInfo(vk::PipelineColorBlendStateCreateFlags(),
                                                                                         false,
                                                                                         vk::LogicOp::eCopy,
...
VulkanPipeline<1, PipelineContext::Compute>::VulkanPipeline(const VulkanDevice& inDevice,
                                                            ...
                                                            const VulkanRenderPassBase& inRenderPass,
                                                            const VulkanPipelineLayoutBase& inLayout,
                                                            const std::array<VulkanShaderModule, 1>& inModules)
    : VulkanPipelineBase(inDevice) {
          auto ShaderStageCreateInfo = vk::PipelineShaderStageCreateInfo(
                    vk::PipelineShaderStageCreateFlags(), vk::ShaderStageFlagBits::eCompute, inModules[0].GetShaderModuleHandle(), "GlslMain");
          auto ComputePipelineCreateInfo =
                    vk::ComputePipelineCreateInfo(vk::PipelineCreateFlags(), ShaderStageCreateInfo, inLayout.GetPipelineLayoutHandle());
