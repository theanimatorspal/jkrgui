...
ksai::VulkanShaderModule::VulkanShaderModule(const VulkanDevice& inDevice, const std::vector<uint32_t>& inSPIRV, bool inShouldDestroy) : mDevice(inDevice.GetDeviceHandle()) {
