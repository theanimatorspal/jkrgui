...
public:
    ...
    inline void DrawIndexed(const VulkanCommandBuffer& inCmdBuffer, int32_t inIndexCount, int32_t inInstanceCount, int32_t inFirstIndex, int32_t inVertexOffset, int32_t inFirstInstance) const;
...
inline void VulkanPipelineBase::DrawIndexed(
