...
namespace ksai {
template <BufferContext inBufferContext, MemoryType inBufferStorageType> class VulkanBufferVMA : public VulkanBufferBase {
      public:
...
inline VulkanBufferVMA<inBufferContext, inBufferStorageType>::VulkanBufferVMA(const VulkanVMA& inVMA, const VulkanDevice& inDevice, size_t inSize)
    : VulkanBufferBase(inDevice), mAllocator(inVMA) {
          ...
          auto BufferCreateInfo = vk::BufferCreateInfo(
                    vk::BufferCreateFlags(), inSize, vk::BufferUsageFlagBits::eVertexBuffer | vk::BufferUsageFlagBits::eTransferDst);
