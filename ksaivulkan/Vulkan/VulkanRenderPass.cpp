...
template <>
VulkanRenderPass<RenderPassContext::Shadow>::VulkanRenderPass(const VulkanDevice &inDevice, VulkanImageBase &inDepthImage)
    : mDevice(&inDevice.GetDeviceHandle()) {
    vk::Format DepthImageFormat               = inDepthImage.GetImageFormat();
    vk::AttachmentDescription DepthAttachment = vk::AttachmentDescription(vk::AttachmentDescriptionFlags(), DepthImageFormat)
                                                     .setInitialLayout(vk::ImageLayout::eUndefined)
    ...
    vk::SubpassDependency SubpassDependency1                      = vk::SubpassDependency()
                                                    .setSrcSubpass(VK_SUBPASS_EXTERNAL)
                                                    .setDstSubpass(0)
    ...
    vk::SubpassDependency SubpassDependency2 = vk::SubpassDependency()
                                                    .setSrcSubpass(0)
                                                    ...
                                                    .setDependencyFlags(vk::DependencyFlagBits::eByRegion);
    std::vector<vk::SubpassDependency> SubpassDependencies = {SubpassDependency1, SubpassDependency2};
    mRenderPass                                            = mDevice->createRenderPass(vk::RenderPassCreateInfo()
                                                 .setAttachmentCount(AttachmentDescriptions.size())
                                                 .setAttachments(AttachmentDescriptions)
                                                 .setSubpasses(SubpassDescriptions)
...
VulkanRenderPass<RenderPassContext::MSAA>::VulkanRenderPass(const VulkanDevice &inDevice,
    ...
    vk::AttachmentDescription ColorAttachment =
         vk::AttachmentDescription(vk::AttachmentDescriptionFlags(),
              ...
              .setInitialLayout(vk::ImageLayout::eUndefined)
              .setFinalLayout(vk::ImageLayout::eColorAttachmentOptimal) // For multi sampled images cannot be
                                                                        // presented directly
              .setLoadOp(vk::AttachmentLoadOp::eClear)
              .setStoreOp(vk::AttachmentStoreOp::eStore)
    ...
    vk::AttachmentDescription ColorAttachmentResolve =
         vk::AttachmentDescription(vk::AttachmentDescriptionFlags(), inColorImageTarget.GetImageFormat())
              .setInitialLayout(vk::ImageLayout::eUndefined)
              .setFinalLayout(vk::ImageLayout::ePresentSrcKHR)
    ...
    vk::SubpassDependency SubpassDependency =
         vk::SubpassDependency()
              ...
              .setDstStageMask(vk::PipelineStageFlagBits::eColorAttachmentOutput |
                               vk::PipelineStageFlagBits::eEarlyFragmentTests | vk::PipelineStageFlagBits::eBottomOfPipe)
              .setSrcAccessMask(vk::AccessFlagBits::eNone)
              .setDstAccessMask(vk::AccessFlagBits::eColorAttachmentWrite | vk::AccessFlagBits::eDepthStencilAttachmentWrite);
...
template <>
VulkanRenderPass<RenderPassContext::SingleColorAttachment>::VulkanRenderPass(const VulkanDevice &inDevice,
                                                                             VulkanImageBase &inColorImage)
    : mDevice(&inDevice.GetDeviceHandle()) {
    vk::AttachmentDescription ColorAttachment =
...
template <>
VulkanRenderPass<RenderPassContext::Deferred>::VulkanRenderPass(const VulkanDevice &inDevice,
