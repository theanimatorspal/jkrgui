...
inline constexpr void VulkanBufferBase::FillBufferUsage(vk::BufferCreateInfo& inInfo) {
          if constexpr (inBufferContext == BufferContext::Vertex)
                    ...
                    inInfo.setUsage(vk::BufferUsageFlagBits::eStorageBuffer | vk::BufferUsageFlagBits::eVertexBuffer |
                    ...
                    inInfo.setUsage(vk::BufferUsageFlagBits::eStorageBuffer | vk::BufferUsageFlagBits::eUniformBuffer |
                                    vk::BufferUsageFlagBits::eTransferDst);
}
