...
VulkanSurface& VulkanSurface::ProcessCurrentSurfaceConditions(const VulkanPhysicalDevice& inPhysicalDevice, vk::PresentModeKHR inMode) {
               ...
               mPresentMode = inMode;
               mPreTransform =
                         (mSurfaceCapabilities.supportedTransforms & vk::SurfaceTransformFlagBitsKHR::eIdentity) ? vk::SurfaceTransformFlagBitsKHR::eIdentity : mSurfaceCapabilities.currentTransform;
