...
void Create2DBindings(Instance& i, Window& w, sol::state& l, EventManager& em, Jkr::Renderer::_2d& td, Jkr::Renderer::BestText_Alt& ALT, Jkr::Misc::FrameCapturer& inFrameCapturer)
{
	/* JKRGUI UI Bindings */
	l.set_function("save_screenshot_now", [&](std::string_view inFileName) {
		// TODO RGBA is ulto I guess
		inFrameCapturer.CaptureToFile(inFileName);
		});
