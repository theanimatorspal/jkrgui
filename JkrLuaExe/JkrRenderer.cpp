...
void CreateRendererBindings(sol::state& inState) {
               ...
               Jkr.new_usertype<ShapeRendererResources>("ShapeRendererResources", sol::call_constructor, []() { return ShapeRendererResources(); }, "Add", &ShapeRendererResources::Add);
               ...
               Jkr.new_usertype<Jkr::Renderer::Generator>(
                         ...
                         sol::factories([]() { return Jkr::Renderer::Generator(); }, [](Jkr::Shapes inShape, Jkr::Generator::Arguments inArg) { return Jkr::Renderer::Generator(inShape, inArg); }));
               Jkr.new_usertype<Jkr::Renderer::Shape>("ShapeRenderer",
                                                      sol::call_constructor,
               ...
               Jkr.new_usertype<Jkr::Renderer::Line>(
                         "LineRenderer",
                         sol::call_constructor,
                         sol::factories([](Jkr::Instance& inInstance, Jkr::WindowMulT& inWindow, Jkr::PainterCache& inCache) { return mu<Jkr::Renderer::Line>(inInstance, inWindow, inCache); }),
                         "Add",
