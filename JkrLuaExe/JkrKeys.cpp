...
void CreateKeyBindings(sol::state& s)
{
	...
	lua["SDL_SCANCODE_HELP"] = 117,
		lua["SDL_SCANCODE_MENU"] = 118,
		lua["SDL_SCANCODE_SELECT"] = 119;
	lua["SDL_SCANCODE_STOP"] = 120,
		lua["SDL_SCANCODE_AGAIN"] = 121,
		lua["SDL_SCANCODE_UNDO"] = 122;
