...
void CreateBasicBindings(sol::state& s) {
               ...
               Jkr.new_usertype<Jkr::Instance>(
                         "Instance", sol::call_constructor, sol::factories([](int inDescriptorSize, int inPoolSize) { return std::make_unique<Jkr::Instance>(inDescriptorSize, inPoolSize); }));
               Jkr.new_usertype<Jkr::Window>("WindowBase");
               Jkr.new_usertype<Jkr::WindowMulT>("Window",
                                                 sol::base_classes,
