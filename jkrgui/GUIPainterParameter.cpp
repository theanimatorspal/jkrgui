...
void Jkr::GUIPainterParameterBase::Setup(Up<StorageBufferType>& inStorageBuffer, vk::DeviceSize inDeviceSize)
{
...
void Jkr::GUIPainterParameterBase::Setup(Up<UniformBufferType>& inUniformBuffer, vk::DeviceSize inDeviceSize, void** inMappedMemoryRegion)
{
...
void Jkr::GUIPainterParameterBase::Setup(Up<VulkanSampler>& inStorageImageSampler, Up<StorageImageType>& inStorageImage, uint32_t inWidth, uint32_t inHeight)
{
...
void Jkr::GUIPainterParameterBase::Setup(Up<VulkanSampler>& inUniformImageSampler, Up<UniformImageType>& inUniformImage, std::string inFileName)
{
	int Width;
	int Height;
	int Channels;
...
void Jkr::GUIPainterParameterBase::Setup(Up<VulkanSampler>& inUniformImageSampler, Up<UniformImageType>& inUniformImage, void** inData, uint32_t inWidth, uint32_t inHeight, uint32_t inChannelCount)
{
