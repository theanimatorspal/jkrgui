...
namespace Jkr::Renderer
{
	...
	public:
		...
		ResourceManager& Store(const Jkr::Instance& inInstance) {
			...
			ksai::Shader FastText(LineRendererShaders::VertexShader, LineRendererShaders::FragmentShader);
			ksai::Shader FastTextCompute(8, LineRendererShaders::ComputeShader);
