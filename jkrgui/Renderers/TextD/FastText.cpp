...
fb::TextDimensions Jkr::Renderer::FastText::AddText(const std::string_view inText,
                                                    uint32_t inX,
                                                    uint32_t inY,
...
#ifndef JKR_NO_STAGING_BUFFERS
    rb::CopyToStagingBuffers(fb::GetVertexBufferData(),
...
fb::TextDimensions Jkr::Renderer::FastText::UpdateText(uint32_t inId,
    ...
    rb::RegisterBufferCopyRegionToPrimitiveFromStaging(fb::CharCountToVertexBytes(Offset),
                                                       fb::CharCountToIndexBytes(Offset),
                                                       fb::CharCountToVertexBytes(inText.size()),
                                                       fb::CharCountToIndexBytes(inText.size()));
#else
...
void Jkr::Renderer::FastText::Draw(Window& inWindow,
                                   glm::vec4 inColor,
                                   uint32_t inWindowW,
                                   uint32_t inWindowH,
