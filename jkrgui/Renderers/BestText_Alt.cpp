...
void Jkr::Renderer::BestText_Alt::Add(
 ui inFontId, glm::vec2 inPos, int inDepth, const sv inText, ImageId& outId, ksai::optref<ksai::ThreadPool> inThreadPool, bool inAlignBottom) {
          ZoneScoped;
          ...
          ui font_rect_id;
          Jkr::Generator FontRectGen(Jkr::Shapes::RectangleFill, glm::uvec2(dimens.mWidth, dimens.mHeight));
          if (inAlignBottom) {
...
void Jkr::Renderer::BestText_Alt::Update(
 ImageId inId, ui inFontId, glm::vec2 inPos, int inDepth, const sv inText, ksai::optref<ksai::ThreadPool> inThreadPool, bool inAlignBottom) {
          Jkr::Renderer::BestText_base::TextDimensions dimens;
          using namespace ksai;
          int y;
          v<uc> img = bt.RenderTextToImage(inFontId, inText, dimens, inThreadPool, y);
