...
void Jkr::Renderer::BestText_Alt::AddEXT(ui inFontId, glm::vec2 inPos, int inDepth, const sv inText, ImageId& outId)
{
    Jkr::Renderer::BestText_base::TextDimensions dimens;
...
void Jkr::Renderer::BestText_Alt::UpdateEXT(ImageId inId, ui inFontId, glm::vec2 inPos, int inDepth, const sv inText)
{
    Jkr::Renderer::BestText_base::TextDimensions dimens;
    v<uc> img = bt.RenderTextToImage(inFontId, inText, dimens, i.GetThreadPool());
    sh.UpdateImage(inId.mImgId, img, dimens.mWidth, dimens.mHeight);
...
void Jkr::Renderer::BestText_Alt::UpdatePosOnlyEXT(ImageId inId, ui inFontId, glm::vec2 inPos, int inDepth, const sv inText)
{
...
void Jkr::Renderer::BestText_Alt::DrawEXT(ImageId inId, Window& inWindow, glm::vec4 inColor, ui inW, ui inH, glm::mat4 inMatrix)
{
    sh.BindImage(inWindow, inId.mImgId);
    sh.Draw(inWindow, inColor, inW, inH, inId.mRectId, inId.mRectId, inMatrix);
}
