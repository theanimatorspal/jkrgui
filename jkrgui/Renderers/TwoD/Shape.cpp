...
Shape::Shape(const Instance& inInstance, Window& inCompatibleWindow,
	   std::unordered_map<FillType, Up<PainterCache>>& inPainterCaches, ui inVarDesCount)
...
void Shape::Draw(Window& inWindow, glm::vec4 inColor, ui inWindowW, ui inWindowH, ui inStartShapeId, ui inEndShapeId,
	       glm::mat4 inMatrix) {
