...
public:
    ...
    virtual const std::array<VulkanCommandBuffer, 2U>& GetCommandBuffers() const override
    {
    ...
    void Executeall()
    {
        mCommandBuffers[mCurrentFrame].ExecuteCommands(mSecondaryCommandBufferBackground[mCurrentFrame], mSecondaryCommandBuffersUI[mCurrentFrame]);
    }
