...
void CreateBasicBindings(sol::state &s) {
                    ...
                    Jkr.new_usertype<Jkr::Instance>(
                         ...
                         sol::factories([](int inDescriptorSize,
                                           int inPoolSize,
                                           bool inEnableValidation) {
                    ...
                    Jkr.new_usertype<Jkr::Window>(
                         ...
                         sol::factories(
                              [](Jkr::Instance &inInstance,
                                 ...
                                 int inHeight,
                                 int inThreadsCount) {
                                                  int NoOfCmdBufferPerThread =
                                                       2; // TODO Don't hardcode
                                                  std::vector<ui> CmdBufferCountPerThreadVec;
                                                  CmdBufferCountPerThreadVec.resize(
                                                       inThreadsCount, NoOfCmdBufferPerThread);
                    ...
                    auto PainterCacheTypeEnum =
                         Jkr.new_enum<false>("PainterType",
                                             "Default",
