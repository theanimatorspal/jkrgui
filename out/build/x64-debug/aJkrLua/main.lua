...
Load = function()
        ...
        TextLineEditorSecond = Com.TextLineEditObject:New(vec3(20, 80, Depth - 1), vec3(100, 20, 1), 5, Font, 20, MovableArea)
        TextMultiLineEditor = Com.TextMultiLineEditObject:New(vec3(220, 10, __Depth), vec3(300, 200, 1), 5, 20, Font, 5, 20, nil)
