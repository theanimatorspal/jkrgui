...
Com.TextLabelObject = {
    ...
    SetParent = function(self, inObject)
        -- self.mPosition_3f.x = inObject.mPosition_3f.x + self.mPosition_3f.x
        -- self.mPosition_3f.y = inObject.mPosition_3f.y + self.mPosition_3f.y
        --ComTable[self.mIds.x]:Update(self.mPosition_3f)
        if inObject.mPosition_3f.x > 0 and inObject.mPosition_3f.y > 0 then
             ...
             print("Scissor:", "XY:",  self.mScissorPosition_2f.x, self.mScissorPosition_2f.y, "WH:", self.mScissorDimension_2f.x, self.mScissorDimension_2f.y)
        end
        print("Updated Comtable")
    end
}
