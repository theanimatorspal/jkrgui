...
Load = function()
        ...
        SampleText = Com.TextLabelObject:New("Hello", vec3(400, 510, Depth), Font)
        print("TextLabelObject Created")
        SampleText.mPosition_3f = vec3(400, 500, Depth)
...
Update = function()
        SampleText:Update(vec3(100, 500 * math.sin(Time / 10000), Depth))
        FrameUpdate()
end
